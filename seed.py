...
def seed_options():
    options = [
        ...
        ("mes_vencimento", "Dia fixo do mês", "dia_fixo", "", 1),
        ...
        ("suspensao", "Inadimplência 2 ou + Parcelas", "inadimplencia_2", "6.9  A inadimplência de 2 ou mais parcelas autoriza a CONTRATADA a suspender os serviços até quitação integral.", 1),
